# 贡献指南 (CONTRIBUTING)
> 📖 **文档导航**：[README](./index.md) · [文档索引](./DOCUMENTATION.md) · [开发指南](./DEVELOPMENT.md) · [安全指南](./SECURITY.md) · [更新日志](./CHANGELOG.md)
> 🎯 **适用人群**：贡献者 / 开发者
> ⏱️ **预计阅读时间**：35 分钟
...
本文阐述贡献流程、代码规范与审核要求。在开始之前，请先了解项目概览 [README.md](./index.md)，开发细节参阅 [DEVELOPMENT.md](./DEVELOPMENT.md)，安全考量见 [SECURITY.md](./SECURITY.md)，版本发布历史可查看 [CHANGELOG.md](./CHANGELOG.md)。
...
- **功能添加**：
  ...
  - 更新 [USER_GUIDE.md](./USER_GUIDE.md) 与 [README.md](./index.md)
...
### 维护记录
- 所有文档修改都必须在 [./MAINTENANCE_LOG.md](./MAINTENANCE_LOG.md) 记录，建议在合并当天完成登记。
