...
class Certificate(Base):
    ...
    status: Mapped[str] = mapped_column(String(20), nullable=False, default=CertificateStatus.ACTIVE.value)
    ...
    private_key_secret: Mapped[Optional["EncryptedSecret"]] = relationship("EncryptedSecret")
