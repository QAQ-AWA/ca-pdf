...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_file_metadata_owner_id", "file_metadata", ["owner_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["certificate_file_id"], ["file_metadata.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["owner_id"], ["users.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(
            ["private_key_secret_id"], ["encrypted_secrets.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("serial_number", name="uq_certificates_serial_number"),
    )
    op.create_index(
        "ix_certificates_owner_id", "certificates", ["owner_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["image_file_id"], ["file_metadata.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["image_secret_id"], ["encrypted_secrets.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["owner_id"], ["users.id"], ondelete="SET NULL"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["secret_id"], ["encrypted_secrets.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("name", name="uq_ca_artifacts_name"),
    )
    op.create_index(
        "ix_ca_artifacts_type", "ca_artifacts", ["artifact_type"], unique=False
    )
